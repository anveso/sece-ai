...
def build_tools(db: Session, user_id: UUID):
    ...
    def search_documents(query: str) -> str:
        ...
        institutional knowledge base (official SECE policies, syllabi,
        circulars, and content pulled from sece.ac.in). Returns the most
        relevant excerpts with their source filenames, or a message saying
        nothing was found."""
